...
- [x] **Fase 2: Seguridad Básica**: Restringir el dominio de `cors()` en `server/index.js` en producción y añadir un *Rate Limiting* al inicio de sesión para impedir fuerza bruta sobre la Base de Datos.
